...
type CompetitionServiceClient interface {
	...
	CompetitionStages(ctx context.Context, in *CompetitionRequest, opts ...grpc.CallOption) (*CompetitionListResponse, error)
	ListCompetitions(ctx context.Context, in *CompetitionListRequest, opts ...grpc.CallOption) (*CompetitionListResponse, error)
...
func (c *competitionServiceClient) CompetitionStages(ctx context.Context, in *CompetitionRequest, opts ...grpc.CallOption) (*CompetitionListResponse, error) {
	out := new(CompetitionListResponse)
	err := c.cc.Invoke(ctx, "/gymkhana.CompetitionService/CompetitionStages", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *competitionServiceClient) ListCompetitions(ctx context.Context, in *CompetitionListRequest, opts ...grpc.CallOption) (*CompetitionListResponse, error) {
	out := new(CompetitionListResponse)
	err := c.cc.Invoke(ctx, "/gymkhana.CompetitionService/ListCompetitions", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CompetitionServiceServer interface {
	...
	CompetitionStages(context.Context, *CompetitionRequest) (*CompetitionListResponse, error)
	ListCompetitions(context.Context, *CompetitionListRequest) (*CompetitionListResponse, error)
...
func (UnimplementedCompetitionServiceServer) CompetitionStages(context.Context, *CompetitionRequest) (*CompetitionListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CompetitionStages not implemented")
}
func (UnimplementedCompetitionServiceServer) ListCompetitions(context.Context, *CompetitionListRequest) (*CompetitionListResponse, error) {
...
func _CompetitionService_CompetitionStages_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CompetitionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CompetitionServiceServer).CompetitionStages(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gymkhana.CompetitionService/CompetitionStages",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CompetitionServiceServer).CompetitionStages(ctx, req.(*CompetitionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _CompetitionService_ListCompetitions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gymkhana.CompetitionService/ListCompetitions",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CompetitionServiceServer).ListCompetitions(ctx, req.(*CompetitionListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
